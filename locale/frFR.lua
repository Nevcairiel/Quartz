local L = LibStub:GetLibrary("AceLocale-3.0", true):NewLocale("Quartz3", "frFR", true)
...
L["GCD"] = "TRG"
L["Tradeskill"] = "RegroupementCréations"
...
L["Name Text Position"] = "Position du nom"
L["Name Text Font Size"] = "Taille du nom"
L["Spell Rank"] = "Rang du sort"
L["Spell Rank Style"] = "Style du rang du sort"
L["Hide Name Text"] = "Masquer le nom"
...
L["Name Text X Offset"] = "Position X du nom"
L["Name Text Y Offset"] = "Position Y du nom"
...
L["Adjust the X position of the name text"] = "Ajuste la position X du nom"
...
--GCD
L["%s spell to check for the Global Cooldown"] = "Sort %s à vérifier pour le temps de recharge global"
...
L["Invalid Spell"] = "Sort invalide"
L["Spell_Warning"] = "|cffff3333Attention : Vous n'avez choisi aucun sort pour le module \"Temps de recharge global\" de Quartz. Veuillez entrer un nom de sort dans le menu (/quartz, puis cliquez sur Temps de recharge global). Notez qu'il est recommandé d'utiliser un sort qui ne peut avoir un temps de recharge autre que le temps de recharge gobal et qui ne peut être interrompu, comme Découverte d'herbes"
--Buffs
L["%dm"] = "%dm"
--Mirror
...
L["Timers module currently disabled, re-enable it in the menu"] = "Module des minuteurs actuellement désactivé, réactivez-le par le menu"
